...
// Insert добавляет значение в дерево и поддерживает сбалансированность дерева.
...
// Find пересекает дерево в поисках указанного дерева.
...
// Delete удаляет ключ из дерева и сохраняет его сбалансированным.
